...
let mousePos: MousePos, lastMousePos: MousePos, cacheMousePos: MousePos;
...
export class ImageTrail {
  ...
  DOM: { el?: HTMLElement } = {}; // Object to hold DOM elements
  images: Image[] = []; // Array to store Image objects
