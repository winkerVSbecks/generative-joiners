...
export class Image {
  ...
  DOM!: {
    el: HTMLElement; // Holds the reference to the main DOM element with class 'content__img'.
    inner: HTMLElement; // Holds the reference to the inner DOM element with class 'content__img-inner'.
  };
